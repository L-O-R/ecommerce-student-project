        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-4 top-4 text-sm text-gray-9"
            >
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-4 rounded-full text-lg font-semibold hover:bg-hard-primary transition"
          >
            Create Account
          </button>
        </form>
